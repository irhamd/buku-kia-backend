...
class DashboardController extends Controller
{
    public function getData( Request $req )
    {
        $datacount = DB::select("
            ...
            from(
                SELECT * from pgd_pengaduan_t WHERE created_at BETWEEN '$req->tglawal' and '$tgl->tglakhir'
            and aktif = '1'
            ) as rr
        ");
        ...
        $datachart = DB::select("
            SELECT 
                ...
                sum( case when progres <> 'dn' then 1 else 0 end ) as pending
            from(
                SELECT * , extract( day from  created_at ) AS  tgl from pgd_pengaduan_t WHERE created_at BETWEEN '$req->tglawal' and '$tgl->tglakhir' and aktif = '1'
            ) as rr
        ...
        $databyruangan = DB::select("
            ...
            from(
                ...
                WHERE pdt.created_at BETWEEN '$req->tglawal' and '$tgl->tglakhir' and pdt.aktif = '1'
